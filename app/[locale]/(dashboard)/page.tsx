...
export default function HomePage() {
  ...
  const hero = isCreatorView ? landingContent.hero.creator : landingContent.hero.brand;
  const platform = isCreatorView ? landingContent.platform.creator : landingContent.platform.brand;
  const workflow = isCreatorView ? landingContent.workflow.creator : landingContent.workflow.brand;
  const testimonials = isCreatorView ? landingContent.testimonials.creator : landingContent.testimonials.brand;
  const callToAction = isCreatorView ? landingContent.callToAction.creator : landingContent.callToAction.brand;
